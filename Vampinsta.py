#!/usr/bin/env python3
'''Vampinsta Reporter Is a tool which reports a targeted instagram account. 
...
def startMessage ():#line:7
    ...
    OOOO0OO000OO0OOOO ="@aruack_official"#line:9
    if OOOO0OO000OO0OOOO !=OO0O0OO0OOO0OO0O0 :#line:10
        print (Fore .RED +'[X] Wrong Code')#line:11
        print (Fore .BLUE +''' 
   1. Go to telegram
   2. Join our telegram https://t.me/aruack_official
   3. Check pinned post of Vampinsta
